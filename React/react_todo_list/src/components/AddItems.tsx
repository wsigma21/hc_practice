...
export const AddItems = () => {
  ...
  return (
    <div className="w-full mb-5">
      ...
      <button className="w-3/12 py-1.5 border border-green-500 rounded-md bg-green-500 text-white hover:bg-white hover:text-green-500" onClick={onAddTodo}>追加</button>
    </div>
  )
}